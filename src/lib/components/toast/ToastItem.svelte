...
<div
	...
	class="relative flex w-full max-w-md overflow-hidden rounded-2xl border border-zinc-200/80 bg-white/95 p-4 shadow-xl backdrop-blur-md transition-all duration-300 hover:shadow-2xl dark:border-zinc-800/80 dark:bg-zinc-950/95 dark:shadow-none"
